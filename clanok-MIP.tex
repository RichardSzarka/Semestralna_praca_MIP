...
\begin{itemize}
\item \textbf{Komunita}: na hľadanie správnych nových tandem partnerov (aj podľa rovnakých záľub aby konverzácie boli živšie)
\item \textbf{Učiteľov}: tandem partneri sa nemôžu považovať za jazykových expertov, preto tandem umožňuje spojenie sa s učiteľmi jazyka.
\item \textbf{Čety}: na prehľad a sumarizáciu konverzácii uživateľa
\end{itemize}
